package com.example.dolang.Helper;
...
import com.example.dolang.Activity.DetectListSensorActivity;
...
public class PermissionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(PermissionsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
            startActivity(new Intent(PermissionsActivity.this, DetectListSensorActivity.class));
            finish();
            return;
        }
